...
*/
     var Task003Start_a60ea484_fcbc_4e27_b3d2_852831c7328fStart_Controller = BaseController.extend({
       ...
       */
       ...
       try{
              ...
              */
              ...
              this.$scope.instance = "Task003Start_a60ea484_fcbc_4e27_b3d2_852831c7328fStart_Controller";
              
              }
              catch(exception){
                               console.error("Gadget Exception in init block of Task003Start_a60ea484_fcbc_4e27_b3d2_852831c7328fStart_Controller: "+exception);
                                }
       ...
       try{
              ...
              this.$scope.registerAndShowComponents=function(){
       		      ...
       		      var taskTypeID = "a60ea484-fcbc-4e27-b3d2-852831c7328f";
            	  ...
            	  _this.restClient.url("/rest/pub/opentask")
   				 ...
   				 .success(function(response){
   					...
   					_this.$scope.eventBus.fireEvent(NotificationConstants.ERROR,"Error Creating Task "+response);
                               ...
                               console.error("Gadget Exception in defineScope block of Task003Start_a60ea484_fcbc_4e27_b3d2_852831c7328fStart_Controller: "+exception);
                                }  
       },
});
/*
...
*/
Task003Start_a60ea484_fcbc_4e27_b3d2_852831c7328fStart_Controller.$inject = [ '$scope', 'RestServiceProvider','EventBus','$log','config','$builder'];
