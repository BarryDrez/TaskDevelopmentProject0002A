...
*/
     var Task002Start_a830446c_6378_4357_a336_35b88b9182b9Start_Controller = BaseController.extend({
       ...
       */
       ...
       try{
              ...
              */
              ...
              this.$scope.instance = "Task002Start_a830446c_6378_4357_a336_35b88b9182b9Start_Controller";
              
              }
              catch(exception){
                               console.error("Gadget Exception in init block of Task002Start_a830446c_6378_4357_a336_35b88b9182b9Start_Controller: "+exception);
                                }
       ...
       try{
              ...
              this.$scope.registerAndShowComponents=function(){
       		      ...
       		      var taskTypeID = "a830446c-6378-4357-a336-35b88b9182b9";
            	  ...
            	  _this.restClient.url("/rest/pub/opentask")
   				 ...
   				 .success(function(response){
   					...
   					_this.$scope.eventBus.fireEvent(NotificationConstants.ERROR,"Error Creating Task "+response);
                               ...
                               console.error("Gadget Exception in defineScope block of Task002Start_a830446c_6378_4357_a336_35b88b9182b9Start_Controller: "+exception);
                                }  
       },
});
/*
...
*/
Task002Start_a830446c_6378_4357_a336_35b88b9182b9Start_Controller.$inject = [ '$scope', 'RestServiceProvider','EventBus','$log','config','$builder'];
