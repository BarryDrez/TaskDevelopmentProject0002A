...
*/
     var Task001Start_5951631c_8167_4aeb_8490_0a777fad5d10Start_Controller = BaseController.extend({
       ...
       */
       ...
       try{
              ...
              */
              ...
              this.$scope.instance = "Task001Start_5951631c_8167_4aeb_8490_0a777fad5d10Start_Controller";
              
              }
              catch(exception){
                               console.error("Gadget Exception in init block of Task001Start_5951631c_8167_4aeb_8490_0a777fad5d10Start_Controller: "+exception);
                                }
       ...
       try{
              ...
              this.$scope.registerAndShowComponents=function(){
       		      ...
       		      var taskTypeID = "5951631c-8167-4aeb-8490-0a777fad5d10";
            	  ...
            	  _this.restClient.url("/rest/pub/opentask")
   				 ...
   				 .success(function(response){
   					...
   					_this.$scope.eventBus.fireEvent(NotificationConstants.ERROR,"Error Creating Task "+response);
                               ...
                               console.error("Gadget Exception in defineScope block of Task001Start_5951631c_8167_4aeb_8490_0a777fad5d10Start_Controller: "+exception);
                                }  
       },
});
/*
...
*/
Task001Start_5951631c_8167_4aeb_8490_0a777fad5d10Start_Controller.$inject = [ '$scope', 'RestServiceProvider','EventBus','$log','config','$builder'];
